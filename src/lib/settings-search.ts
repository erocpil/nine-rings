...
const entries: SettingsSearchEntry[] = [
  { title: "清雅配色", description: "清雅系列 · 浅色、深色或跟随系统", keywords: "清雅 深色 浅色 系统 风格 配色", page: "appearance", target: '[data-settings-label="界面风格"]' },
  { title: "界面风格", description: "外观与布局 · 经典自定义外观，清雅系列统一配色与排版", keywords: "风格 清雅 紧凑 经典 demo 界面 留白 密度 样式 style", page: "appearance", target: '[data-settings-label="界面风格"]' },
  {
    title: "更新记录",
